...
const dictionary = {
  en: {
    ...
    'bookings.delete_confirm': 'Are you sure you want to delete this session record?',
  ...
  uz: {
    ...
    'bookings.delete_confirm': 'Ushbu dars haqidagi ma\'lumotni o\'chirishni xohlaysizmi?',
    'bookings.delete_success': 'Dars haqidagi ma\'lumot muvaffaqiyatli o\'chirildi',
    'bookings.delete_error': 'Dars ma\'lumotini o\'chirishda xatolik yuz berdi',
  ...
  ru: {
    ...
    'bookings.delete_confirm': 'Вы уверены, что хотите удалить эту запись о занятии?',
