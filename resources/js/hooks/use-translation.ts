...
const dictionary = {
    en: {
        ...
        'teachers_directory.filter_ielts_desc': 'IELTS Band (High to Low)',
        ...
        'sessions.teacher_feedback': "Teacher's Feedback",
        ...
        'progress.sessions_per_week': 'sessions / week',
        'progress.sessions_completed': 'Sessions completed',
        'progress.minutes_spoken': 'Minutes spoken',
        'progress.teachers_tried': 'Teachers tried',
        'progress.week_1_done': 'Week 1 done',
        'progress.you_are_here': 'You are here',
        'progress.week_2_goal': 'Week 2 goal',
        ...
        'profile.connected_services_desc':
            'Manage third-party integrations and calendar synchronization.',
        'profile.google_calendar_title': 'Google Calendar',
        'profile.google_calendar_connected_desc':
            'Google Calendar is actively connected. Google Meet links are automatically generated for your scheduled practice sessions.',
        'profile.google_calendar_disconnected_desc':
            'Google Calendar is not connected. Connect your account to enable automatic Google Meet link creation for your sessions.',
        'profile.google_calendar_disconnect_btn': 'Disconnect Calendar',
        'profile.google_calendar_connect_btn': 'Connect Google Calendar',
        'profile.disconnect_modal_title': 'Disconnect Google Calendar?',
        'profile.disconnect_modal_desc':
        ...
        'profile.disconnect_modal_cancel': 'Keep Connected',
        'profile.disconnect_modal_confirm': 'Disconnect Calendar',
        'profile.delete_account_google_calendar_notice':
        ...
        // gamification & student delight
        'gamification.level_1_title': 'Hesitant Explorer',
        'gamification.level_2_title': 'Active Conversationalist',
        'gamification.level_3_title': 'Fearless Speaker',
        'gamification.level_4_title': 'Fluent Storyteller',
        'gamification.level_5_title': 'Master Orator',
        'gamification.fluency_level': 'Fluency Level :level',
        'gamification.xp_to_next': ':xp XP to :title',
        'gamification.max_level_achieved': 'Maximum Fluency Achieved!',
        'gamification.speaking_xp': 'Speaking XP',
        'gamification.total_xp': ':count Total XP',
        'gamification.streak_dormant': 'Resting Spark',
        'gamification.streak_spark': 'Ember Spark',
        'gamification.streak_blaze': 'Rising Blaze',
        'gamification.streak_thunder': 'Thunder Flame',
        'gamification.streak_diamond': 'Diamond Flame',
        'gamification.next_streak_milestone': ':days days until :target-day milestone!',
        'gamification.streak_shield_active': 'Streak Shield Active — 1 missed day protected',
        'gamification.leaderboard_title': 'Weekly Top Speakers',
        'gamification.leaderboard_subtitle': 'Learners who practiced the most English this week',
        'gamification.minutes_spoken': ':count mins',
        'gamification.your_standing': 'Your Current Standing',
        'gamification.rank': 'Rank #:rank',
        'gamification.distance_to_top_5': ':mins mins away from Top 5!',
        'gamification.in_top_5': 'You are in the Top 5 this week! Keep it up! 🏆',
        'gamification.empty_leaderboard': 'Be the first speaker to claim the #1 spot this week!',
        'gamification.daily_spark_badge': 'Daily Speaking Spark',
        'gamification.daily_spark_sub': 'Think and practice out loud to build effortless speech flow',
        'gamification.spark_practice_btn': 'Practice with a Teacher',
        'gamification.spark_peer_btn': 'Instant Peer Match',
        'gamification.pro_speaking_tip': 'Speaking Tip',
        'gamification.spark_cat_travel': 'Travel & Adventure',
        'gamification.spark_cat_ambition': 'Ambition & Dreams',
        'gamification.spark_cat_debate': 'Debate & Perspectives',
        'gamification.spark_cat_life': 'Life & Wisdom',
        'gamification.spark_cat_tech': 'Tech & Future',
        'gamification.spark_cat_culture': 'Culture & Heritage',
        'gamification.spark_cat_curiosity': 'Curiosity & History',
        'gamification.spark_q1': 'If you could travel anywhere in the world tomorrow with all expenses paid, where would you go and why?',
        'gamification.spark_tip1': 'Describe the sights, sounds, and 3 activities you would do there.',
        'gamification.spark_q2': 'What is one personal goal that you are excited to achieve before the end of this year?',
        'gamification.spark_tip2': 'Use future continuous or perfect tense: "By December, I will have..."',
        'gamification.spark_q3': 'Would you rather live without smartphones for a month, or without the internet entirely for two weeks?',
        'gamification.spark_tip3': 'Defend your choice with 2 clear benefits and 1 trade-off you accept.',
        'gamification.spark_q4': 'What is the most memorable advice anyone has ever given you, and how did it impact your life?',
        'gamification.spark_tip4': 'Structure your story: The situation, the words, and the lasting change.',
        'gamification.spark_q5': 'How do you think artificial intelligence will shape education and language learning over the next decade?',
        'gamification.spark_tip5': 'Contrast digital tools with the irreplaceable warmth of human conversation.',
        'gamification.spark_q6': 'What is a traditional dish or custom from your hometown that every visitor must experience?',
        'gamification.spark_tip6': 'Use descriptive sensory adjectives (rich, comforting, mouth-watering).',
        'gamification.spark_q7': 'If you could have a 30-minute English conversation with any historical figure, who would you choose and what would you ask?',
        'gamification.spark_tip7': 'Formulate 2 thought-provoking questions you would bring to the table.',
        'gamification.celeb_title': 'Awesome Speaking Session!',
        'gamification.celeb_subtitle': 'Every sentence you speak rewires your brain for true fluency.',
        'gamification.celeb_earned': 'You earned +:xp Speaking XP',
        'gamification.celeb_close': 'Keep Moving Forward',
    },
    uz: {
        // common / layout
        ...
        'nav.start_speaking': 'Suhbatni boshlash',
        ...
        'sessions.teacher_feedback': "O'qituvchining fikri",
        ...
        'progress.my_progress': 'Mening natijalarim',
        'progress.sessions_per_week': 'dars / hafta',
        'progress.sessions_completed': 'Tugallangan darslar',
        'progress.minutes_spoken': 'Gapirilgan daqiqalar',
        'progress.teachers_tried': "Sinalgan o'qituvchilar",
        'progress.week_1_done': '1-hafta bajarildi',
        ...
        'profile.connected_services': 'Ulangan xizmatlar',
        'profile.connected_services_desc':
            'Tashqi integratsiyalar va taqvim sinxronizatsiyasini boshqaring.',
        'profile.google_calendar_title': 'Google Taqvim',
        'profile.google_calendar_connected_desc':
            "Google Taqvim faol ulangan. Rejalashtirilgan mashg'ulotlaringiz uchun Google Meet havolalari avtomatik yaratiladi.",
        'profile.google_calendar_disconnected_desc':
            'Google Taqvim ulanmagan. Darslaringiz uchun avtomatik Google Meet havolalarini yaratish uchun hisobingizni ulang.',
        'profile.google_calendar_disconnect_btn': 'Taqvimni uzish',
        'profile.google_calendar_connect_btn': 'Google Taqvimni ulash',
        'profile.disconnect_modal_title': 'Google Taqvim uzilsinmi?',
        'profile.disconnect_modal_desc':
            "Google Taqvimni uzish ConvMate ruxsatini bekor qiladi va keyingi darslar uchun avtomatik Google Meet havolalari yaratilishi to'xtatiladi. Istalgan vaqtda qayta ulanishingiz mumkin.",
        'profile.disconnect_modal_cancel': 'Ulangan holda qoldirish',
        'profile.disconnect_modal_confirm': 'Taqvimni uzish',
        'profile.delete_account_google_calendar_notice':
            'Google Taqvim ulanishi avtomatik bekor qilinadi va Google hisobingizdan ilova ruxsati olib tashlanadi.',
        ...
        // gamification & student delight
        'gamification.level_1_title': "Boshlang'ich tadqiqotchi",
        'gamification.level_2_title': 'Faol suhbatdosh',
        'gamification.level_3_title': "Jasur so'zlovchi",
        'gamification.level_4_title': 'Erkin hikoyachi',
        'gamification.level_5_title': 'Usta notiq',
        'gamification.fluency_level': ':level-darajali ravonlik',
        'gamification.xp_to_next': ':title darajasiga :xp XP qoldi',
        'gamification.max_level_achieved': 'Eng yuqori daraja zabt etildi!',
        'gamification.speaking_xp': "So'zlashuv XP",
        'gamification.total_xp': 'Jami :count XP',
        'gamification.streak_dormant': "Uyg'onish arafasida",
        'gamification.streak_spark': 'Uchqun alangasi',
        'gamification.streak_blaze': "Qizg'in olov",
        'gamification.streak_thunder': 'Momaqaldiroq olovi',
        'gamification.streak_diamond': 'Olmos olov',
        'gamification.next_streak_milestone': ':target-kunlik marragacha :days kun qoldi!',
        'gamification.streak_shield_active': "Streak qalqoni faol — 1 ta o'tkazib yuborilgan kun himoyalangan",
        'gamification.leaderboard_title': "Haftaning eng faol so'zlovchilari",
        'gamification.leaderboard_subtitle': "Bu hafta ingliz tilida eng ko'p so'zlashgan o'quvchilar",
        'gamification.minutes_spoken': ':count daqiqa',
        'gamification.your_standing': "Sizning o'rningiz",
        'gamification.rank': ":rank-o'rin",
        'gamification.distance_to_top_5': 'Top 5 talikka kirish uchun yana :mins daqiqa!',
        'gamification.in_top_5': 'Siz bu hafta Top 5 talikdasiz! Shunday davom eting! 🏆',
        'gamification.empty_leaderboard': "Bu hafta 1-o'rinni egallagan ilk so'zlovchi bo'ling!",
        'gamification.daily_spark_badge': 'Kunlik soʻzlashuv uchquni',
        'gamification.daily_spark_sub': "Nutqingizni erkinlashtirish uchun o'ylab ko'ring va ovoz chiqarib javob bering",
        'gamification.spark_practice_btn': "O'qituvchi bilan mashq qilish",
        'gamification.spark_peer_btn': 'Sherik bilan bogʻlanish',
        'gamification.pro_speaking_tip': 'Foydali maslahat',
        'gamification.spark_cat_travel': 'Sayohat va sarguzasht',
        'gamification.spark_cat_ambition': 'Orzular va maqsadlar',
        'gamification.spark_cat_debate': 'Bahs va fikrlar',
        'gamification.spark_cat_life': 'Hayot va hikmat',
        'gamification.spark_cat_tech': 'Texnologiya va kelajak',
        'gamification.spark_cat_culture': 'Madaniyat va meros',
        'gamification.spark_cat_curiosity': 'Qiziqish va tarix',
        'gamification.spark_q1': "Agar ertaga butun xarajatlari to'langan istalgan joyga sayohat qilish imkoni bo'lsa, qayerga borardingiz va nega?",
        'gamification.spark_tip1': "U yerda qiladigan 3 ta mashg'ulotni va ko'rinishlarni tasvirlab bering.",
        'gamification.spark_q2': "Bu yil yakuniga qadar erishmoqchi bo'lgan eng qiziqarli shaxsiy maqsadingiz nima?",
        'gamification.spark_tip2': 'Kelasi zamon shakllaridan foydalaning: "Yil oxiriga qadar men..."',
        'gamification.spark_q3': "Bir oy davomida smartphonesiz yashashni ma'qul ko'rasizmi yoki ikki hafta butunlay internetsiz?",
        'gamification.spark_tip3': "Tanlovingizni 2 ta afzallik va 1 ta qiyinchilik bilan asoslab bering.",
        'gamification.spark_q4': "Sizga berilgan eng unutilmas maslahat qaysi va u hayotingizni qanday o'zgartirdi?",
        'gamification.spark_tip4': "Vaziyat, aytilgan so'zlar va ularning ta'sirini ketma-ketlikda so'zlab bering.",
        'gamification.spark_q5': "Sun'iy intellekt kelasi o'n yillikda til o'rganishni qanday o'zgartiradi deb o'ylaysiz?",
        'gamification.spark_tip5': "Texnologiya qulayliklarini insoniy jonli muloqot bilan taqqoslang.",
        'gamification.spark_q6': "Shahringizdagi har bir sayyoh albatta tatib ko'rishi kerak bo'lgan taom yoki odat qaysi?",
        'gamification.spark_tip6': "Mazali va ta'sirli sifatlardan foydalaning (mazali, yoqimli, betakror).",
        'gamification.spark_q7': "Tarixdagi istalgan shaxs bilan 30 daqiqa inglizcha suhbatlashish imkoni bo'lsa, kimni tanlardingiz va nima so'rardingiz?",
        'gamification.spark_tip7': "Suhbatga tayyorlab boradigan 2 ta chuqur savolingizni ifodalang.",
        'gamification.celeb_title': "Ajoyib so'zlashuv darsi!",
        'gamification.celeb_subtitle': 'Har bir gapirgan gapingiz ravonlik tomon tashlangan ishonchli qadamdir.',
        'gamification.celeb_earned': "Siz +:xp So'zlashuv XP qo'lga kiritdingiz",
        'gamification.celeb_close': 'Davom etish',
    },
    ru: {
        // common / layout
        ...
        'teachers_directory.filter_ielts_desc': 'Балл IELTS (по убыванию)',
        ...
        'nav.start_speaking': 'Начать разговор',
        ...
        'sessions.teacher_feedback': 'Отзыв преподавателя',
        ...
        'progress.my_progress': 'Мой прогресс',
        'progress.sessions_per_week': 'уроков / неделю',
        'progress.sessions_completed': 'Завершенные уроки',
        'progress.minutes_spoken': 'Минут разговорной речи',
        'progress.teachers_tried': 'Опробовано преподавателей',
        'progress.week_1_done': 'Неделя 1 выполнена',
        'progress.you_are_here': 'Вы здесь',
        ...
        'profile.connected_services': 'Подключенные сервисы',
        'profile.connected_services_desc':
            'Управление внешними интеграциями и синхронизацией календаря.',
        'profile.google_calendar_title': 'Google Календарь',
        'profile.google_calendar_connected_desc':
            'Google Календарь успешно подключен. Ссылки Google Meet создаются автоматически для всех ваших запланированных сессий.',
        'profile.google_calendar_disconnected_desc':
            'Google Календарь не подключен. Подключите аккаунт для автоматического создания ссылок Google Meet.',
        'profile.google_calendar_disconnect_btn': 'Отключить Календарь',
        'profile.google_calendar_connect_btn': 'Подключить Google Календарь',
        'profile.disconnect_modal_title': 'Отключить Google Календарь?',
        'profile.disconnect_modal_desc':
            'Отключение Google Календаря отзовет доступ ConvMate и прекратит автоматическое создание ссылок Google Meet для будущих уроков. Вы сможете подключить его снова в любое время.',
        'profile.disconnect_modal_cancel': 'Оставить подключенным',
        'profile.disconnect_modal_confirm': 'Отключить Календарь',
        'profile.delete_account_google_calendar_notice':
            'Подключение к Google Календарю будет автоматически отменено, а доступ приложения отозван в вашем Google Аккаунте.',
        ...
        // gamification & student delight
        'gamification.level_1_title': 'Робкий исследователь',
        'gamification.level_2_title': 'Активный собеседник',
        'gamification.level_3_title': 'Бесстрашный спикер',
        'gamification.level_4_title': 'Свободный рассказчик',
        'gamification.level_5_title': 'Мастер оратор',
        'gamification.fluency_level': 'Уровень беглости :level',
        'gamification.xp_to_next': ':xp XP до уровня :title',
        'gamification.max_level_achieved': 'Максимальный уровень достигнут!',
        'gamification.speaking_xp': 'XP за разговор',
        'gamification.total_xp': 'Всего :count XP',
        'gamification.streak_dormant': 'Спящая искра',
        'gamification.streak_spark': 'Яркая искра',
        'gamification.streak_blaze': 'Разгорающееся пламя',
        'gamification.streak_thunder': 'Громовое пламя',
        'gamification.streak_diamond': 'Бриллиантовое пламя',
        'gamification.next_streak_milestone': ':days дн. до цели в :target дней!',
        'gamification.streak_shield_active': 'Щит серии активен — 1 пропущенный день защищен',
        'gamification.leaderboard_title': 'Топ спикеров недели',
        'gamification.leaderboard_subtitle': 'Студенты, которые больше всего практиковали английский на этой неделе',
        'gamification.minutes_spoken': ':count мин',
        'gamification.your_standing': 'Ваше место',
        'gamification.rank': 'Место #:rank',
        'gamification.distance_to_top_5': 'Ещё :mins мин до Топ-5!',
        'gamification.in_top_5': 'Вы в Топ-5 на этой неделе! Так держать! 🏆',
        'gamification.empty_leaderboard': 'Станьте первым спикером, занявшим 1-е место на этой неделе!',
        'gamification.daily_spark_badge': 'Тема дня для беседы',
        'gamification.daily_spark_sub': 'Подумайте и ответьте вслух, чтобы тренировать спонтанную речь',
        'gamification.spark_practice_btn': 'Практиковать с учителем',
        'gamification.spark_peer_btn': 'Быстрый подбор собеседника',
        'gamification.pro_speaking_tip': 'Совет для беседы',
        'gamification.spark_cat_travel': 'Путешествия и приключения',
        'gamification.spark_cat_ambition': 'Цели и мечты',
        'gamification.spark_cat_debate': 'Мнения и дискуссии',
        'gamification.spark_cat_life': 'Жизнь и опыт',
        'gamification.spark_cat_tech': 'Технологии и будущее',
        'gamification.spark_cat_culture': 'Культура и традиции',
        'gamification.spark_cat_curiosity': 'Любопытство и история',
        'gamification.spark_q1': 'Если бы вы могли отправиться в любую точку мира завтра за чужой счёт, куда бы вы поехали и почему?',
        'gamification.spark_tip1': 'Опишите атмосферу, звуки и 3 вещи, которые вы там сделаете.',
        'gamification.spark_q2': 'Какую важную личную цель вы больше всего хотите достичь до конца этого года?',
        'gamification.spark_tip2': 'Используйте формы будущего времени: "К концу года я..."',
        'gamification.spark_q3': 'Что бы вы предпочли: месяц без смартфона или две недели вообще без интернета?',
        'gamification.spark_tip3': 'Аргументируйте выбор: назовите 2 плюса и 1 компромисс, на который готовы пойти.',
        'gamification.spark_q4': 'Какой самый ценный совет вам когда-либо давали, и как он повлиял на вашу жизнь?',
        'gamification.spark_tip4': 'Постройте ответ последовательно: ситуация, сам совет и долгосрочный эффект.',
        'gamification.spark_q5': 'Как искусственный интеллект повлияет на изучение языков в ближайшие 10 лет?',
        'gamification.spark_tip5': 'Сравните эффективность технологий с ценностью живого человеческого общения.',
        'gamification.spark_q6': 'Какое традиционное блюдо или обычай вашего города должен попробовать каждый гость?',
        'gamification.spark_tip6': 'Используйте яркие прилагательные (ароматный, сытный, неповторимый).',
        'gamification.spark_q7': 'Если бы вы могли поговорить 30 минут на английском с любой исторической личностью, кого бы вы выбрали и о чем спросили?',
        'gamification.spark_tip7': 'Сформулируйте 2 глубоких вопроса для начала разговора.',
        'gamification.celeb_title': 'Отличный разговорный урок!',
        'gamification.celeb_subtitle': 'Каждая минута живой речи приближает вас к настоящей беглости.',
        'gamification.celeb_earned': 'Вы заработали +:xp XP за разговор',
        'gamification.celeb_close': 'Продолжить',
    },
};
