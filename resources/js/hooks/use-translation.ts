...
const dictionary = {
    en: {
        ...
        'packages.standard_rate_info': 'Standard rate: :rate :currency / hour (Standard total for :hours h: :total :currency)',
    ...
    uz: {
        ...
        'packages.standard_rate_info': 'Standart narx: :rate :currency / soat (Standart jami :hours soat uchun: :total :currency)',
    ...
    ru: {
        ...
        'packages.standard_rate_info': 'Стандартная ставка: :rate :currency / час (Стандартно за :hours ч: :total :currency)',
