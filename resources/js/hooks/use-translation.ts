...
const dictionary = {
    en: {
        ...
        'welcome.nav_why_humans': 'Why humans',
        'welcome.nav_about': 'About',
        'welcome.login': 'Log in',
        'welcome.be_teacher': 'Be a teacher',
        'welcome.teach_short': 'Teach',
        'welcome.book_lesson': 'Find a tutor',
        'welcome.book_short': 'Tutors',
        'welcome.language': 'Language:',
        'welcome.hero_badge': '✦ ConvoMate English Speaking Platform — Live 1-on-1 Practice',
        'welcome.hero_title_speak': 'Speak with ',
        'welcome.hero_title_humans': 'humans',
        'welcome.hero_title_not': ', not ',
        'welcome.hero_title_bots': 'bots.',
        'welcome.hero_title_prefix': 'Speak with ',
        'welcome.hero_title_highlight1': 'humans',
        'welcome.hero_title_mid': ', not ',
        'welcome.hero_title_highlight2': 'bots',
        'welcome.hero_title_suffix': '.',
        'welcome.hero_subtitle': 'ConvoMate is an interactive English speaking platform where learners book live 1-on-1 sessions with IELTS-verified teachers for real-time conversation practice, fluency coaching, and personalized feedback.',
        'welcome.meet_teachers': 'Meet the teachers',
        'welcome.hero_trust': "🛡 Every teacher's certificate is checked by ConvoMate.",
        'welcome.live_lesson': 'Live lesson',
        'welcome.teacher_label': 'Teacher',
        'welcome.student_label': 'Student',
        'welcome.hero_student_callout_label': 'Student · speaking 90% of the lesson',
        'welcome.hero_dialogue_teacher': '"Tell me about your weekend — past tense, full sentences."',
        'welcome.hero_dialogue_student': '"I visited my grandmother and we cooked plov together."',
        'welcome.about_badge': 'About ConvoMate Platform',
        'welcome.about_title': '1-on-1 English Speaking Platform & Automated Scheduling',
        'welcome.about_desc1': 'ConvoMate is an interactive online platform designed to connect English learners with IELTS-verified teachers for real-time 1-on-1 video lessons, conversation practice, and fluency coaching.',
        'welcome.about_desc2': 'ConvoMate uses Google Sign-In for secure, fast user authentication and integrates with Google Calendar to automatically schedule speaking lessons and generate Google Meet video conference links for confirmed student-teacher sessions.',
        'welcome.why_title': "AI can generate text. It can't feel awkwardness.",
        'welcome.why_subtitle': 'Here is why real human practice beats every language app on your phone.',
        'welcome.why_f1_title': 'Real feedback, mid-sentence',
        'welcome.why_f1_desc': "Your pronunciation gets fixed the second it slips — not summarized in a report you'll never open again.",
        'welcome.why_f2_title': 'The exam is a human, too',
        'welcome.why_f2_desc': "IELTS Speaking is an interview with a person. The only realistic rehearsal is with a person who knows how it's scored.",
        'welcome.why_f3_title': 'Personalized Adaptability',
        'welcome.why_f3_desc': 'A human tutor notices when you get hesitant or confused, adjusting the topic pace dynamically.',
        'welcome.verified_title': 'Verified means verified',
        'welcome.verified_desc': 'Before any teacher appears here, we check their IELTS certificate ourselves. The badge is our word, not theirs.',
        'welcome.how_title': 'Three steps to your first conversation',
        'welcome.how_subtitle': 'From sign-up to speaking in under ten minutes.',
        'welcome.how_step_1_title': 'Create your account',
        'welcome.how_step_1_desc': 'Two minutes. Tell us your level and your goal — IELTS band, job interview, or just confidence.',
        'welcome.mock_name': 'Name',
        'welcome.mock_level': 'Your level',
        'welcome.mock_create_acc': 'Create account',
        'welcome.how_step_2_title': 'Choose a teacher and time',
        'welcome.how_step_2_desc': 'Real profiles, checked certificates, live availability. Book the slot that fits your day.',
        'welcome.mock_verified': '✔ Verified',
        'welcome.mock_book_btn': 'Book · 17:30',
        'welcome.how_step_3_title': 'Join the call and speak',
        'welcome.how_step_3_desc': 'One click to join. No software downloads. Speak for 30 or 60 minutes and leave with feedback.',
        'welcome.mock_starts_in': 'Lesson starts in 5 min',
        'welcome.mock_freestyle': 'Freestyle conversation · Dilnoza · 1 h · 🕐 17:30',
        'welcome.mock_join': 'Join now',
        'welcome.teachers_section_title': 'Certified teachers, ready to talk',
        'welcome.teachers_section_subtitle': 'Every profile is verified before it goes live. Here are a few who have slots open this week.',
        'welcome.slots_available': 'Slots available',
        'welcome.reviews': 'reviews',
        'welcome.book_with_teacher': 'Book lesson with :name',
        'welcome.browse_all_teachers': 'Browse all verified teachers',
        'welcome.bottom_cta_title': 'Ready to speak with confidence?',
        'welcome.bottom_cta_subtitle': 'Book your lesson in under 2 minutes. Free during early access beta.',
        'welcome.book_now': 'Find a tutor now',
        'welcome.footer_rights_text': 'All rights reserved. Real humans, real results.',
        'welcome.footer_privacy': 'Privacy Policy',
        'welcome.footer_terms': 'Terms of Service',
        'welcome.teacher_kamola_title': 'IELTS Speaking Specialist',
        'welcome.teacher_kamola_desc': 'Exam strategy and fluency coaching · 5 yrs experience',
        'welcome.teacher_kamola_badge': 'IELTS teacher · ✔ Verified',
        'welcome.teacher_javohir_title': 'Conversational Fluency',
        'welcome.teacher_javohir_desc': 'Accent reduction & everyday vocabulary · 4 yrs experience',
        'welcome.teacher_javohir_badge': 'General English · ✔ Verified',
        'welcome.teacher_dilnoza_title': 'Business & Interview Prep',
        'welcome.teacher_dilnoza_desc': 'Corporate English & interview simulations · 6 yrs experience',
        'welcome.teacher_dilnoza_badge': 'Business English · ✔ Verified',
        ...
        'auth.hourly_rate': 'Hourly Rate',
        'auth.hourly_rate_placeholder': 'e.g. 50 000 (can be 0)',
        'auth.currency_som': "so'm",
        ...
        'auth.select_certificate': 'Select Certificate',
        ...
        'auth.lang_english': 'English',
        'auth.lang_korean': 'Korean',
        'auth.lang_japanese': 'Japanese',
        'auth.lang_german': 'German',
        'auth.lang_french': 'French',
        'auth.lang_cefr': 'Multi-Language',
        'auth.lang_other': 'Other',
        'auth.custom_language_label': 'Language Name',
        'auth.custom_language_placeholder': 'e.g. Spanish, Arabic, Italian, Turkish',
        'auth.score_overall_toefl': 'Total Score (0–120)',
        'auth.score_overall_det': 'Overall Score (10–160)',
        'auth.score_overall_topik': 'Total Score',
        'auth.score_overall_jlpt': 'Total Score (0–180)',
        'auth.score_overall_goethe': 'Total Points (0–100)',
        'auth.score_overall_testdaf': 'Overall Result',
        'auth.score_overall_delf': 'Total Score (0–100)',
        'auth.score_overall_cefr': 'CEFR Level',
        'auth.score_overall_custom': 'Overall Grade / Score',
        'auth.score_literacy': 'Literacy',
        'auth.score_comprehension': 'Comprehension',
        'auth.score_conversation': 'Conversation',
        'auth.score_production': 'Production',
        'auth.score_language_knowledge': 'Language Knowledge',
        'auth.score_reading_de': 'Lesen (Reading)',
        'auth.score_listening_de': 'Hören (Listening)',
        'auth.score_writing_de': 'Schreiben (Writing)',
        'auth.score_speaking_de': 'Sprechen (Speaking)',
        'auth.score_reading_testdaf': 'Leseverstehen',
        'auth.score_listening_testdaf': 'Hörverstehen',
        'auth.score_writing_testdaf': 'Schriftlicher Ausdruck',
        'auth.score_speaking_testdaf': 'Mündlicher Ausdruck',
        'auth.score_listening_fr': 'Compréhension orale',
        'auth.score_reading_fr': 'Compréhension écrite',
        'auth.score_writing_fr': 'Production écrite',
        'auth.score_speaking_fr': 'Production orale',
        'auth.cert_file_optional': 'Certificate file (optional)',
        'auth.drop_cert_file': 'Drop your certificate here or browse',
        'auth.drop_cert_hint': 'PDF, JPG, or PNG · up to 10 MB',
        'auth.replace_file': 'Replace',
        'auth.remove_file': 'Remove',
        'teacher.view_certificate': 'View Certificate',
        'teacher.verified_certificate': 'Verified Certificate',
        'teacher.open_original_file': 'Open Original Document',
        'teacher.close_modal': 'Close',
        'teacher.click_to_expand': 'Click to expand',
        'teacher.document_preview': 'Document preview',
        'teacher.official_document_preview': 'Official Certificate Document',
        'teacher.pdf_preview_hint': 'If the document does not display in your browser, use the open or download button above.',
        ...
        'payment.teacher_label': 'Teacher:',
        'payment.name_label': 'Name:',
        'payment.id_label': 'ID:',
        ...
        'dashboard.completed_conversations': 'Completed Conversations',
        'dashboard.completed_conversations_desc': 'Finished speaking sessions',
        'dashboard.speaking_time': 'Total Speaking Time',
        'dashboard.speaking_time_desc': 'Total time in live conversations',
        'teacher.completed_conversations': ':count lessons',
        'teacher.speaking_time': ':time spoken',
        ...
        'gamification.day_streak': ':count Day Streak',
        'gamification.days_streak': ':count Days Streak',
        'gamification.shield_active': 'Shield Active',
        ...
        'gamification.leaderboard_practice_btn': 'Practice Now',
        'gamification.empty_leaderboard_desc': 'Complete a lesson or start a peer conversation to lead the community!',
        'gamification.empty_leaderboard_action': 'Book a Speaking Session',
        'gamification.no_sessions_this_week': 'No sessions yet this week',
        'gamification.user_minutes_spoken': ':count minutes spoken this week',
        'gamification.top_five_badge': 'Top 5 Speaker 🌟',
        'gamification.climb_ranks_hint': 'Keep speaking to climb the ranks! 🚀',
        'gamification.minutes_spoken': ':count minutes',
        ...
        'gamification.xp_gained': 'XP Gained',
        'packages.title': 'Conversation Packs',
        'packages.admin_desc': 'Confirm payments to activate conversation packages for pupils.',
        'packages.subtitle': 'Discounted conversation hours with this teacher',
        'packages.hours_count': ':count Hours',
        'packages.discount_badge': ':discount% OFF',
        'packages.buy_button': 'Buy Pack',
        'packages.buying': 'Processing...',
        'packages.price': 'Price',
        'packages.regular_price': 'Regular: :price',
        'packages.savings': 'Save :amount',
        'packages.teacher_discount': 'Discount :amount',
        'packages.active_package': 'Active Conversation Pack',
        'packages.remaining_time': 'Remaining: :time',
        'packages.covered_badge': 'Covered by your Pack (Free Booking)',
        'packages.covered_session_desc': 'Lesson duration: :duration. Remaining pack balance after booking: :remaining.',
        'packages.insufficient_title': 'Insufficient Conversation Pack Balance',
        'packages.insufficient_minutes': 'Your active pack has only :remaining remaining. Booking this :duration lesson requires regular payment or purchasing a new pack.',
        'packages.rate_per_hour': 'Rate per hour',
        'packages.pending_verification': 'Package purchase pending payment verification',
        'packages.view_payment_details': 'Payment Details',
        'packages.create_pack': 'Create Conversation Pack',
        'packages.edit_pack': 'Edit Pack',
        'packages.pack_title': 'Pack Title',
        'packages.pack_hours': 'Total Hours',
        'packages.pack_price': 'Total Price',
        'packages.no_packages': 'No conversation packs available yet',
        'packages.status_active': 'Active',
        'packages.status_inactive': 'Inactive',
        'packages.delete_confirm': 'Are you sure you want to delete this pack?',
        'packages.purchase_success': 'Package purchase request submitted! Admin will verify payment shortly.',
        'packages.purchased_notice': 'You have an active pack with this teacher! Available hours are automatically applied for free bookings.',
        'packages.manage_title': 'Conversation Packs & Bulk Hours',
        'packages.manage_desc': 'Offer pupils bundled conversation hours at special discounted rates to encourage long-term bookings.',
        'packages.modal_create_desc': 'Set bulk conversation hours and discounted pricing for pupils.',
        'packages.modal_edit_desc': 'Update conversation package hours, rate, and details.',
        'packages.custom_hours': 'Custom Hours',
        'packages.hours': 'Hours',
        'packages.pack_title_placeholder': 'e.g., 5 Hours Conversation Pack',
        'packages.pack_price_placeholder': 'e.g., 400 000',
        'packages.discount_optional': 'Discount % (Optional)',
        'packages.discount_placeholder': 'e.g., 20',
        'packages.standard_rate_info': 'Standard rate: :rate :currency / hour (Standard total for :hours: :total :currency)',
        'packages.desc_optional': 'Description (Optional)',
        'packages.desc_placeholder': 'e.g., Focus on IELTS speaking and daily fluency',
        'packages.cancel_btn': 'Cancel',
        'packages.save_btn': 'Save Pack',
        'packages.update_btn': 'Update Pack',
        'packages.saving_btn': 'Saving...',
        'packages.empty_encourage': 'Encourage pupils to commit to multiple conversation sessions by offering bundled hours at an attractive discount.',
        'packages.hours_validation': 'Please enter a valid number of hours',
        'packages.price_validation': 'Please enter a valid price',
        'packages.update_success': 'Conversation pack updated successfully',
        'packages.create_success': 'Conversation pack created successfully',
        'packages.delete_success': 'Package deleted or deactivated',
        'packages.delete_error': 'Failed to delete package',
        'packages.status_updated': 'Package status updated',
        'packages.status_activated': '":name" package is now active',
        'packages.status_deactivated': '":name" package is now inactive',
        'packages.status_update_error': 'Failed to update status',
        'packages.error_duplicate_title': 'A conversation pack with this title already exists.',
        'packages.error_duplicate_duration_discount': 'You already have a package with this duration and discount percentage.',
        'auth.error_invalid_phone': 'Please enter a valid phone number (e.g. +998 90 123 45 67).',
        'auth.error_invalid_name': 'Name should only contain letters, spaces, and hyphens (minimum 2 characters).',

        // support page
        'support.title': 'ConvoMate Support',
        'support.help_desk': 'Help & Support Desk',
        'support.help_desk_desc': 'Contact the ConvoMate platform admins, report an issue, or read announcements.',
        'support.send_message_title': 'Send Message to Admin',
        'support.send_message_desc': 'Have a question, feedback, or payment issue? Send us a direct message.',
        'support.subject': 'Subject',
        'support.subject_placeholder': 'e.g., Booking error or Payment question',
        'support.message': 'Message',
        'support.message_placeholder': 'Describe your issue or feedback in detail...',
        'support.send_button': 'Send Message',
        'support.sending_button': 'Sending...',
        'support.history_title': 'Your Communication History',
        'support.history_desc': 'Direct replies from administrators and system broadcast announcements.',
        'support.no_messages': 'No Messages Yet',
        'support.no_messages_desc': 'When admins reply to your inquiries or send platform announcements, they will appear here.',
        'support.badge_broadcast': 'Broadcast Announcement',
        'support.badge_personal': 'Personal Message from Admin',
        'support.badge_ticket': 'Ticket',
        'support.default_subject': 'Support Request',
        'support.message_sent_success': 'Your message has been sent to ConvoMate Support.',
        'support.official_broadcast': 'Official Admin Broadcast',
        'support.admin_label': 'Admin',
        'support.you_sent': 'You sent:',
        'nav.support': 'ConvoMate Support',

        // sessions additional
        'sessions.mgmt_badge': 'Session Management',
        'sessions.history_badge': 'Session History',
        'sessions.history_title': 'My Lessons',
        'sessions.history_desc': 'Review all booked, upcoming, and past lessons with your pupils.',
        'sessions.tab_all': 'All',
        'sessions.tab_upcoming': 'Upcoming',
        'sessions.tab_completed': 'Completed',
        'sessions.trial_badge': 'Trial · :duration min',
        'sessions.lesson_badge': 'Lesson · :duration min',
        'sessions.paid_badge': 'Paid',
        'sessions.awaiting_payment': 'Accepted · Awaiting Payment',
        'sessions.new_student_desc': '— new student, first session with you',
        'sessions.third_of_rate': '⅓ of your rate',
        'sessions.full_rate': 'your full rate',
        'sessions.join_lesson': 'Join lesson',
        'sessions.feedback_btn': 'Feedback',
        'sessions.your_feedback_prefix': 'Your feedback:',
        'sessions.no_lessons': 'No lessons found',
        'sessions.no_lessons_desc': 'Unpaid bookings never appear here — a lesson exists only after the student has paid.',
        'sessions.unpaid_note': '✦ Unpaid bookings never appear here — a lesson exists only after the student has paid.',
        'sessions.quick_stats': 'Quick Stats',
        'sessions.trials_this_week': 'Trials this week',
        'sessions.marketplace_tip_title': 'Marketplace Tip',
        'sessions.marketplace_tip_desc': "A trial is your audition. Assess the student's level, name 2–3 concrete things to work on, and propose a weekly plan — that's how trials become regular students.",
        'sessions.new_trial_toast': 'New trial lesson',
        'sessions.trial_toast_desc': 'booked a trial · :time · :price, already paid. Tip: assess level and propose a plan.',
        'sessions.trial_toast_body': ':name booked a trial · :time · :price :currency, already paid. Tip: assess level and propose a plan.',
        'sessions.session_started': 'Session started',
        'sessions.google_calendar_required': 'Google Calendar connection required to generate Google Meet links.',
        'sessions.connect_google': 'Connect Google',
        'sessions.cannot_start_session': 'Could not start session',
        'sessions.student_fallback': 'Student',
        'sessions.teacher_fallback': 'Teacher',
    },
    uz: {
        // common / layout
        ...
        'welcome.nav_why_humans': 'Nega insonlar',
        'welcome.nav_about': 'Platforma haqida',
        'welcome.login': 'Kirish',
        'welcome.be_teacher': "O'qituvchi bo'lish",
        'welcome.teach_short': "O'qitish",
        'welcome.book_lesson': 'Ustoz topish',
        'welcome.book_short': 'Ustozlar',
        'welcome.language': 'Til:',
        'welcome.hero_badge': '✦ ConvoMate ingliz tili so‘zlashuv platformasi — Jonli 1 ga 1 amaliyot',
        'welcome.hero_title_speak': 'Botlar bilan emas, ',
        'welcome.hero_title_humans': 'insonlar',
        'welcome.hero_title_not': ' bilan ',
        'welcome.hero_title_bots': 'gaplashing.',
        'welcome.hero_title_prefix': '',
        'welcome.hero_title_highlight1': 'Insonlar bilan',
        'welcome.hero_title_mid': ' gaplashing, ',
        'welcome.hero_title_highlight2': 'botlar bilan emas',
        'welcome.hero_title_suffix': '.',
        'welcome.hero_subtitle': "ConvoMate — bu o'quvchilar real muloqot amaliyoti, nutq ravonligi va shaxsiy fikr-mulohazalar olish uchun IELTS sertifikatiga ega o'qituvchilar bilan 1 ga 1 jonli darslar bron qiladigan interaktiv platforma.",
        'welcome.meet_teachers': "O'qituvchilar bilan tanishing",
        'welcome.hero_trust': "🛡 Har bir o'qituvchining sertifikati ConvoMate tomonidan tekshiriladi.",
        'welcome.live_lesson': 'Jonli dars',
        'welcome.teacher_label': "O'qituvchi",
        'welcome.student_label': 'Talaba',
        'welcome.hero_student_callout_label': 'Talaba · darsning 90% qismida gapiradi',
        'welcome.hero_dialogue_teacher': '"Dam olish kuningiz qanday o‘tganini aytib bering — o‘tgan zamonda, to‘liq gaplar bilan."',
        'welcome.hero_dialogue_student': '"Men buvimnikiga bordim va birgalikda osh pishirdik."',
        'welcome.about_badge': 'ConvoMate platformasi haqida',
        'welcome.about_title': '1 ga 1 ingliz tili so‘zlashuv platformasi va avtomatlashtirilgan dars jadvali',
        'welcome.about_desc1': "ConvoMate — bu ingliz tilini o'rganuvchilarni real vaqt rejimida 1 ga 1 video darslar, so'zlashuv amaliyoti va nutq ravonligini rivojlantirish uchun IELTS sertifikatiga ega o'qituvchilar bilan bog'lovchi interaktiv onlayn platforma.",
        'welcome.about_desc2': "ConvoMate tezkor va xavfsiz autentifikatsiya uchun Google Sign-In dan foydalanadi hamda Google Calendar bilan integratsiya qilingan holda darslarni avtomatik rejalashtiradi va tasdiqlangan darslar uchun Google Meet havolalarini yaratadi.",
        'welcome.why_title': 'Sun’iy intellekt matn yarata oladi. Ammo jonli his-tuyg‘uni berolmaydi.',
        'welcome.why_subtitle': 'Nega haqiqiy inson bilan amaliyot telefoningizdagi har qanday ilovadan ustunroq?',
        'welcome.why_f1_title': 'Jumla o‘rtasidayoq jonli tahrir',
        'welcome.why_f1_desc': 'Talaffuzingiz xato ketishi bilanoq to‘g‘rilanadi — keyinchalik hech qachon ochilmaydigan hisobotda emas.',
        'welcome.why_f2_title': 'Imtihon oluvchi ham — inson',
        'welcome.why_f2_desc': 'IELTS Speaking imtihoni inson bilan suhbatdan iborat. Yagona haqiqiy tayyorgarlik — baholash mezonlarini biladigan inson bilan suhbatdir.',
        'welcome.why_f3_title': 'Shaxsiy moslashuvchanlik',
        'welcome.why_f3_desc': "Jonli ustoz sizning ikkilanayotganingizni yoki tushunmayotganingizni darhol sezadi va mavzu sur'atini moslashtiradi.",
        'welcome.verified_title': 'Tasdiqlangan — demak haqiqiy',
        'welcome.verified_desc': "Har bir o'qituvchini e'lon qilishdan oldin ularning IELTS sertifikatini o'zimiz tekshiramiz. Tasdiqlash belgisi — bizning kafolatimizdir.",
        'welcome.how_title': 'Birinchi suhbatingiz sari uch qadam',
        'welcome.how_subtitle': "Ro'yxatdan o'tishdan gapirishgacha — o'n daqiqadan kam vaqt.",
        'welcome.how_step_1_title': 'Profil yarating',
        'welcome.how_step_1_desc': 'Ikki daqiqa. Darajangiz va maqsadingizni ayting — IELTS bali, ish intervyusi yoki shunchaki ishonch.',
        'welcome.mock_name': 'Ism',
        'welcome.mock_level': 'Sizning darajangiz',
        'welcome.mock_create_acc': 'Hisob yaratish',
        'welcome.how_step_2_title': "O'qituvchi va vaqtni tanlang",
        'welcome.how_step_2_desc': "Haqiqiy profillar, tekshirilgan sertifikatlar va bo'sh vaqtlar. Kuningizga mos vaqtni tanlang.",
        'welcome.mock_verified': '✔ Tasdiqlangan',
        'welcome.mock_book_btn': 'Bron · 17:30',
        'welcome.how_step_3_title': "Qo'ng'iroqqa qo'shiling va gapiring",
        'welcome.how_step_3_desc': "Bir bosishda ulaning. Dastur yuklab olish shart emas. 30 yoki 60 daqiqa gapiring va xulosalar oling.",
        'welcome.mock_starts_in': 'Dars 5 daqiqada boshlanadi',
        'welcome.mock_freestyle': 'Erkin muloqot · Dilnoza · 1 soat · 🕐 17:30',
        'welcome.mock_join': 'Hozir qo‘shilish',
        'welcome.teachers_section_title': "Muloqotga tayyor sertifikatlangan o'qituvchilar",
        'welcome.teachers_section_subtitle': "Har bir profil e'lon qilinishidan oldin tekshiriladi. Mana bu hafta bo'sh vaqtlari mavjud o'qituvchilar.",
        'welcome.slots_available': 'Bo‘sh vaqtlar bor',
        'welcome.reviews': 'ta sharh',
        'welcome.book_with_teacher': ":name bilan dars bron qilish",
        'welcome.browse_all_teachers': "Barcha tasdiqlangan o'qituvchilarni ko'rish",
        'welcome.bottom_cta_title': 'O‘zingizga ishonch bilan gapirishga tayyormisiz?',
        'welcome.bottom_cta_subtitle': 'Darsingizni 2 daqiqada bron qiling. Erta kirish beta davrida bepul.',
        'welcome.book_now': 'Hoziroq ustoz toping',
        'welcome.footer_rights_text': 'Barcha huquqlar himoyalangan. Haqiqiy insonlar, haqiqiy natijalar.',
        'welcome.footer_privacy': 'Maxfiylik siyosati',
        'welcome.footer_terms': 'Foydalanish shartlari',
        'welcome.teacher_kamola_title': 'IELTS Speaking mutaxassisi',
        'welcome.teacher_kamola_desc': 'Imtihon strategiyasi va ravonlik murabbiyligi · 5 yillik tajriba',
        'welcome.teacher_kamola_badge': "IELTS o'qituvchisi · ✔ Tasdiqlangan",
        'welcome.teacher_javohir_title': 'So‘zlashuv ravonligi',
        'welcome.teacher_javohir_desc': 'Aksentni to‘g‘rilash va kundalik lug‘at · 4 yillik tajriba',
        'welcome.teacher_javohir_badge': 'Umumiy ingliz tili · ✔ Tasdiqlangan',
        'welcome.teacher_dilnoza_title': 'Biznes va intervyu tayyorgarligi',
        'welcome.teacher_dilnoza_desc': 'Korporativ ingliz tili va intervyu simulyatsiyalari · 6 yillik tajriba',
        'welcome.teacher_dilnoza_badge': 'Biznes ingliz tili · ✔ Tasdiqlangan',
        ...
        'auth.hourly_rate': 'Soatlik narx',
        'auth.hourly_rate_placeholder': 'masalan, 50 000 (0 bo‘lishi mumkin)',
        'auth.currency_som': "so'm",
        ...
        'auth.score_listening': 'Eshitish',
        'auth.score_reading': 'O‘qish',
        'auth.score_writing': 'Yozish',
        'auth.score_speaking': 'Gapirish',
        ...
        'auth.select_language': 'Tilni tanlang',
        'auth.select_certificate': 'Sertifikatni tanlang',
        'lang.english': 'Ingliz tili',
        'lang.german': 'Nemis tili',
        'lang.french': 'Fransuz tili',
        'lang.korean': 'Koreys tili',
        'lang.japanese': 'Yapon tili',
        'lang.spanish': 'Ispan tili',
        'lang.arabic': 'Arab tili',
        'lang.chinese': 'Xitoy tili',
        'lang.russian': 'Rus tili',
        'lang.turkish': 'Turk tili',
        'lang.italian': 'Italyan tili',
        'lang.other': 'Boshqa til',
        'auth.lang_english': 'Ingliz tili',
        'auth.lang_korean': 'Koreys tili',
        'auth.lang_japanese': 'Yapon tili',
        'auth.lang_german': 'Nemis tili',
        'auth.lang_french': 'Fransuz tili',
        'auth.lang_cefr': 'Ko‘p tilli',
        'auth.lang_other': 'Boshqa',
        'auth.custom_language_label': 'Til nomi',
        'auth.custom_language_placeholder': 'masalan: Ispan, Arab, Italyan, Turk',
        'auth.score_overall_toefl': 'Umumiy ball (0–120)',
        'auth.score_overall_det': 'Umumiy ball (10–160)',
        'auth.score_overall_topik': 'Umumiy ball',
        'auth.score_overall_jlpt': 'Umumiy ball (0–180)',
        'auth.score_overall_goethe': 'Umumiy ball (0–100)',
        'auth.score_overall_testdaf': 'Umumiy natija',
        'auth.score_overall_delf': 'Umumiy ball (0–100)',
        'auth.score_overall_cefr': 'CEFR darajasi',
        'auth.score_overall_custom': 'Umumiy ball / baho',
        'auth.score_literacy': 'Savodxonlik (Literacy)',
        'auth.score_comprehension': 'Tushunish (Comprehension)',
        'auth.score_conversation': 'Muloqot (Conversation)',
        'auth.score_production': 'Nutq yaratish (Production)',
        'auth.score_language_knowledge': 'Til bilimi',
        'auth.score_reading_de': 'O‘qish (Lesen)',
        'auth.score_listening_de': 'Eshitish (Hören)',
        'auth.score_writing_de': 'Yozish (Schreiben)',
        'auth.score_speaking_de': 'Gapirish (Sprechen)',
        'auth.score_reading_testdaf': 'Leseverstehen (O‘qish)',
        'auth.score_listening_testdaf': 'Hörverstehen (Eshitish)',
        'auth.score_writing_testdaf': 'Schriftlicher Ausdruck (Yozish)',
        'auth.score_speaking_testdaf': 'Mündlicher Ausdruck (Gapirish)',
        'auth.score_listening_fr': 'Compréhension orale (Eshitish)',
        'auth.score_reading_fr': 'Compréhension écrite (O‘qish)',
        'auth.score_writing_fr': 'Production écrite (Yozish)',
        'auth.score_speaking_fr': 'Production orale (Gapirish)',
        'auth.cert_file_optional': 'Sertifikat fayli (ixtiyoriy)',
        'auth.drop_cert_file': 'Sertifikatni shu yerga tashlang yoki tanlang',
        'auth.drop_cert_hint': 'PDF, JPG yoki PNG · 10 MB gacha',
        'auth.replace_file': 'Almashtirish',
        'auth.remove_file': 'O‘chirish',
        'teacher.view_certificate': 'Sertifikatni ko‘rish',
        'teacher.verified_certificate': 'Tasdiqlangan sertifikat',
        'teacher.open_original_file': 'Asl hujjatni ochish',
        'teacher.close_modal': 'Yopish',
        'teacher.click_to_expand': 'Kattalashtirish uchun bosing',
        'teacher.document_preview': 'Hujjatni ko‘rish',
        'teacher.official_document_preview': 'Rasmiy sertifikat hujjati',
        'teacher.pdf_preview_hint': 'Agar hujjat brauzerda ochilmasa, yuqoridagi tugmalar orqali yuklab oling.',
        ...
        'payment.modal_desc':
            "Quyidagi kartaga to'lov yuboring va kvitansiyangizni Telegram guruhiga ismingiz hamda O'quvchi IDingiz bilan yuboring.",
        ...
        'payment.pupil_id': "O'quvchi ID",
        'payment.total_due': "Jami to'lov",
        'payment.teacher_label': 'Ustoz:',
        'payment.name_label': 'Ism:',
        'payment.id_label': 'ID:',
        'payment.warning_notice':
            "MAJBURIY: Adminlar broningizni tasdiqlashi uchun Telegram-ga chek yuborayotganda ismingiz va O'quvchi ID-ingizni ko'rsating.",
        ...
        'dashboard.book_now': 'Suhbat band qilish',
        ...
        'dashboard.teacher_subtitle':
            "Darslaringiz va bo'sh vaqtlaringizni samarali boshqaring.",
        'dashboard.completed_conversations': 'Yakunlangan darslar',
        'dashboard.completed_conversations_desc': "O'tkazilgan suhbat darslari",
        'dashboard.speaking_time': 'Jami suhbat vaqti',
        'dashboard.speaking_time_desc': 'Jonli darslardagi umumiy vaqt',
        'teacher.completed_conversations': ':count ta dars',
        'teacher.speaking_time': ':time suhbat',
        ...
        'gamification.day_streak': ':count kunlik seriya',
        'gamification.days_streak': ':count kunlik seriya',
        'gamification.shield_active': 'Qalqon faol',
        ...
        'gamification.leaderboard_practice_btn': 'Mashq qilish',
        'gamification.empty_leaderboard_desc': "Hamjamiyatda yetakchi bo'lish uchun darsni yakunlang yoki suhbat boshlang!",
        'gamification.empty_leaderboard_action': 'Suhbat darsini band qilish',
        'gamification.no_sessions_this_week': "Bu hafta hali suhbatlar bo'lmadi",
        'gamification.user_minutes_spoken': "Bu hafta :count daqiqa so'zlashildi",
        'gamification.top_five_badge': "Eng yaxshi 5 talik so'zlovchi 🌟",
        'gamification.climb_ranks_hint': "O'rningizni ko'tarish uchun so'zlashishda davom eting! 🚀",
        ...
        'gamification.xp_gained': 'Ortirilgan XP',
        'packages.title': "Suhbat to'plamlari",
        'packages.admin_desc': "O'quvchilar uchun suhbat to'plamlarini faollashtirish maqsadida to'lovlarni tasdiqlang.",
        'packages.subtitle': "Ushbu ustoz bilan arzonlashtirilgan suhbat soatlarini xarid qiling",
        'packages.hours_count': ":count soat",
        'packages.discount_badge': ":discount% chegirma",
        'packages.buy_button': "To'plamni xarid qilish",
        'packages.buying': 'Jarayonda...',
        'packages.price': 'Narxi',
        'packages.regular_price': 'Oddiy: :price',
        'packages.savings': ':amount tejang',
        'packages.teacher_discount': ':amount chegirma',
        'packages.active_package': "Faol suhbat to'plami",
        'packages.remaining_time': 'Qolgan vaqt: :time',
        'packages.covered_badge': "To'plamingiz hisobidan (Bepul)",
        'packages.covered_session_desc': "Dars davomiyligi: :duration. Darsdan keyin to'plam qoldig'i: :remaining.",
        'packages.insufficient_title': "Suhbat to'plamida daqiqalar yetarli emas",
        'packages.insufficient_minutes': "Faol to'plamingizda faqat :remaining qolgan. Ushbu :duration darsni bron qilish uchun standart to'lov yoki yangi to'plam talab qilinadi.",
        'packages.rate_per_hour': 'Bir soatlik narx',
        'packages.pending_verification': "To'plam to'lovi tekshiruvi kutilmoqda",
        'packages.view_payment_details': "To'lov ma'lumotlari",
        'packages.create_pack': "Suhbat to'plami yaratish",
        'packages.edit_pack': "To'plamni tahrirlash",
        'packages.pack_title': "To'plam nomi",
        'packages.pack_hours': 'Jami soatlar',
        'packages.pack_price': 'Jami narxi',
        'packages.no_packages': "Hozircha suhbat to'plamlari mavjud emas",
        'packages.status_active': 'Faol',
        'packages.status_inactive': 'Faol emas',
        'packages.delete_confirm': "Ushbu to'plamni o'chirib tashlamoqchimisiz?",
        'packages.purchase_success': "To'plam xaridi yuborildi! Administrator tez orada to'lovni tasdiqlaydi.",
        'packages.purchased_notice': "Ushbu ustoz bilan faol to'plamingiz bor! Darslarni bepul band qilish uchun soatlaringiz avtomatik qo'llanadi.",
        'packages.manage_title': "Suhbat to'plamlari",
        'packages.manage_desc': "O'quvchilarga ko'proq soatlarni chegirmali narxda taklif qiling.",
        'packages.modal_create_desc': "O'quvchilar uchun suhbat soatlari to'plami va chegirmali narxlarni belgilang.",
        'packages.modal_edit_desc': "Suhbat to'plami soatlari, narxi va tafsilotlarini yangilang.",
        'packages.custom_hours': 'Boshqa soat',
        'packages.hours': 'Soat',
        'packages.pack_title_placeholder': "Masalan: 5 soatlik suhbat to'plami",
        'packages.pack_price_placeholder': 'Masalan: 400 000',
        'packages.discount_optional': 'Chegirma % (Ixtiyoriy)',
        'packages.discount_placeholder': 'Masalan: 20',
        'packages.standard_rate_info': 'Standart narx: :rate :currency / soat (Standart jami :hours uchun: :total :currency)',
        'packages.desc_optional': 'Tavsif (Ixtiyoriy)',
        'packages.desc_placeholder': "Masalan: IELTS speaking va ravon muloqotga e'tibor qaratiladi",
        'packages.cancel_btn': 'Bekor qilish',
        'packages.save_btn': "To'plamni saqlash",
        'packages.update_btn': "To'plamni yangilash",
        'packages.saving_btn': 'Saqlanmoqda...',
        'packages.empty_encourage': "O'quvchilarga ko'proq soatlarni chegirma bilan taklif qilib, uzoq muddatli darslarga jalb qiling.",
        'packages.hours_validation': "Iltimos, to'g'ri soat miqdorini kiriting",
        'packages.price_validation': "Iltimos, to'g'ri narx kiriting",
        'packages.update_success': "Suhbat to'plami muvaffaqiyatli yangilandi",
        'packages.create_success': "Suhbat to'plami muvaffaqiyatli yaratildi",
        'packages.delete_success': "To'plam o'chirildi yoki nofaol qilindi",
        'packages.delete_error': "To'plamni o'chirishda xatolik yuz berdi",
        'packages.status_updated': "To'plam holati yangilandi",
        'packages.status_activated': '":name" to\'plami faollashtirildi',
        'packages.status_deactivated': '":name" to\'plami faolsizlantirildi',
        'packages.status_update_error': "Holatni yangilashda xatolik yuz berdi",
        'packages.error_duplicate_title': "Ushbu nomdagi suhbat to'plami allaqachon mavjud.",
        'packages.error_duplicate_duration_discount': "Sizda ushbu davomiylik va chegirma foiziga ega to'plam allaqachon mavjud.",
        'auth.error_invalid_phone': "Iltimos, to'g'ri telefon raqamini kiriting (masalan: +998 90 123 45 67).",
        'auth.error_invalid_name': "Ism faqat harflar, bo'shliqlar va chiziqchalardan iborat bo'lishi kerak (kamida 2 ta belgi).",

        // support page
        'support.title': 'ConvoMate Yordam',
        'support.help_desk': "Yordam va qo'llab-quvvatlash",
        'support.help_desk_desc': "ConvoMate ma'murlariga murojaat qiling, muammoni xabar qiling yoki e'lonlarni o'qing.",
        'support.send_message_title': "Ma'murga xabar yuborish",
        'support.send_message_desc': "Savol, fikr-mulohaza yoki to'lov muammosi bormi? Bizga to'g'ridan-to'g'ri xabar yuboring.",
        'support.subject': 'Mavzu',
        'support.subject_placeholder': "Masalan: Bron xatosi yoki To'lov bo'yicha savol",
        'support.message': 'Xabar matni',
        'support.message_placeholder': "Muammoingiz yoki fikringizni batafsil yozing...",
        'support.send_button': 'Xabarni yuborish',
        'support.sending_button': 'Yuborilmoqda...',
        'support.history_title': 'Xabarlar tarixi',
        'support.history_desc': "Ma'muriyatning to'g'ridan-to'g'ri javoblari va umumiy e'lonlar.",
        'support.no_messages': "Hozircha xabarlar yo'q",
        'support.no_messages_desc': "Ma'murlar sizning murojaatingizga javob berishganda yoki tizim e'lonlarini yuborishganda, ular shu yerda ko'rinadi.",
        'support.badge_broadcast': "Umumiy e'lon",
        'support.badge_personal': "Ma'murdan shaxsiy xabar",
        'support.badge_ticket': 'Murojaat',
        'support.default_subject': "Yordam so'rovi",
        'support.message_sent_success': "Xabaringiz ConvoMate qo'llab-quvvatlash xizmatiga yuborildi.",
        'support.official_broadcast': "Rasmiy tizim e'loni",
        'support.admin_label': "Ma'muriyat",
        'support.you_sent': 'Siz yubordingiz:',
        'nav.support': 'ConvoMate Yordam',

        // sessions additional
        'sessions.mgmt_badge': 'Darslarni boshqarish',
        'sessions.history_badge': 'Darslar tarixi',
        'sessions.history_title': 'Mening darslarim',
        'sessions.history_desc': "O'quvchilaringiz bilan barcha band qilingan, bo'lajak va o'tgan darslarni ko'rib chiqing.",
        'sessions.tab_all': 'Barchasi',
        'sessions.tab_upcoming': "Bo'lajak",
        'sessions.tab_completed': 'Yakunlangan',
        'sessions.trial_badge': 'Sinov · :duration daq',
        'sessions.lesson_badge': 'Dars · :duration daq',
        'sessions.paid_badge': "To'langan",
        'sessions.awaiting_payment': "Qabul qilingan · To'lov kutilmoqda",
        'sessions.new_student_desc': "— yangi o'quvchi, siz bilan birinchi darsi",
        'sessions.third_of_rate': "narxingizning ⅓ qismi",
        'sessions.full_rate': "to'liq narxingiz",
        'sessions.join_lesson': 'Darsga kirish',
        'sessions.feedback_btn': 'Izoh qoldirish',
        'sessions.your_feedback_prefix': 'Sizning izohingiz:',
        'sessions.no_lessons': 'Darslar topilmadi',
        'sessions.no_lessons_desc': "To'lanmagan bandliklar bu yerda ko'rinmaydi — dars faqat o'quvchi to'lov qilgandan so'ng paydo bo'ladi.",
        'sessions.unpaid_note': "✦ To'lanmagan bandliklar bu yerda ko'rinmaydi — dars faqat o'quvchi to'lov qilgandan so'ng paydo bo'ladi.",
        'sessions.quick_stats': 'Tezkor statistika',
        'sessions.trials_this_week': 'Bu haftadagi sinov darslari',
        'sessions.marketplace_tip_title': 'Ustozlar uchun maslahat',
        'sessions.marketplace_tip_desc': "Sinov darsi — bu o'z mahoratingizni ko'rsatish imkoniyati. O'quvchi darajasini aniqlang, 2–3 ta ustida ishlash kerak bo'lgan jihatni ayting va haftalik reja taklif qiling.",
        'sessions.new_trial_toast': 'Yangi sinov darsi',
        'sessions.trial_toast_desc': "sinov darsini band qildi · :time · :price, to'langan.",
        'sessions.trial_toast_body': ":name sinov darsini band qildi · :time · :price :currency, to'langan. Maslahat: darajasini baholang va reja tuzing.",
        'sessions.session_started': 'Dars boshlandi',
        'sessions.google_calendar_required': 'Google Meet havolasini yaratish uchun Google Calendar ulanishi kerak.',
        'sessions.connect_google': "Google-ni ulash",
        'sessions.cannot_start_session': "Darsni boshlab bo'lmadi",
        'sessions.student_fallback': "O'quvchi",
        'sessions.teacher_fallback': "O'qituvchi",
    },
    ru: {
        // common / layout
        ...
        'welcome.nav_why_humans': 'Почему люди',
        'welcome.nav_about': 'О платформе',
        'welcome.login': 'Войти',
        'welcome.be_teacher': 'Стать преподавателем',
        'welcome.teach_short': 'Преподавать',
        'welcome.book_lesson': 'Найти репетитора',
        'welcome.book_short': 'Репетиторы',
        'welcome.language': 'Язык:',
        'welcome.hero_badge': '✦ Платформа разговорного английского ConvoMate — Живая практика 1 на 1',
        'welcome.hero_title_speak': 'Говорите с ',
        'welcome.hero_title_humans': 'людьми',
        'welcome.hero_title_not': ', а не с ',
        'welcome.hero_title_bots': 'ботами.',
        'welcome.hero_title_prefix': 'Говорите с ',
        'welcome.hero_title_highlight1': 'людьми',
        'welcome.hero_title_mid': ', а не с ',
        'welcome.hero_title_highlight2': 'ботами',
        'welcome.hero_title_suffix': '.',
        'welcome.hero_subtitle': 'ConvoMate — это интерактивная платформа разговорного английского, где студенты бронируют индивидуальные уроки 1 на 1 с сертифицированными преподавателями IELTS для живой разговорной практики, беглости речи и персональной обратной связи.',
        'welcome.meet_teachers': 'Познакомиться с учителями',
        'welcome.hero_trust': '🛡 Сертификат каждого преподавателя проверен ConvoMate.',
        'welcome.live_lesson': 'Живой урок',
        'welcome.teacher_label': 'Преподаватель',
        'welcome.student_label': 'Студент',
        'welcome.hero_student_callout_label': 'Студент · говорит 90% времени урока',
        'welcome.hero_dialogue_teacher': '"Расскажи о своих выходных — прошедшее время, полными предложениями."',
        'welcome.hero_dialogue_student': '"Я навещал бабушку, и мы вместе готовили плов."',
        'welcome.about_badge': 'О платформе ConvoMate',
        'welcome.about_title': 'Разговорный английский 1 на 1 и автоматическое расписание',
        'welcome.about_desc1': 'ConvoMate — это интерактивная онлайн-платформа, созданная для соединения изучающих английский язык с сертифицированными IELTS преподавателями для видеоуроков 1 на 1, разговорной практики и развития беглости речи.',
        'welcome.about_desc2': 'ConvoMate использует Google Sign-In для быстрой и безопасной авторизации, а также интегрируется с Google Календарем для автоматического планирования уроков и генерации ссылок на видеовстречи Google Meet для подтвержденных занятий.',
        'welcome.why_title': 'ИИ может сгенерировать текст. Но он не чувствует неловкости.',
        'welcome.why_subtitle': 'Вот почему живая практика с человеком превосходит любое приложение в телефоне.',
        'welcome.why_f1_title': 'Мгновенная правка прямо посреди фразы',
        'welcome.why_f1_desc': 'Ваше произношение исправляется в ту же секунду, когда вы ошиблись, а не в отчете, который вы больше никогда не откроете.',
        'welcome.why_f2_title': 'Экзамен принимает тоже человек',
        'welcome.why_f2_desc': 'IELTS Speaking — это живое интервью с человеком. Единственная реалистичная репетиция — это общение с тем, кто знает критерии оценки.',
        'welcome.why_f3_title': 'Индивидуальная адаптивность',
        'welcome.why_f3_desc': 'Живой преподаватель сразу замечает замешательство или неуверенность и динамически подстраивает темп разговора.',
        'welcome.verified_title': 'Проверено — значит гарантировано',
        'welcome.verified_desc': 'Прежде чем анкета преподавателя появится на сайте, мы лично проверяем сертификат IELTS. Значок — это наша гарантия, а не просто их слова.',
        'welcome.how_title': 'Три шага к первому разговору',
        'welcome.how_subtitle': 'От регистрации до первого диалога — менее 10 минут.',
        'welcome.how_step_1_title': 'Создайте аккаунт',
        'welcome.how_step_1_desc': 'Две минуты. Укажите свой уровень и цель — балл IELTS, собеседование или просто уверенность.',
        'welcome.mock_name': 'Имя',
        'welcome.mock_level': 'Ваш уровень',
        'welcome.mock_create_acc': 'Создать аккаунт',
        'welcome.how_step_2_title': 'Выберите учителя и время',
        'welcome.how_step_2_desc': 'Реальные анкеты, проверенные сертификаты и актуальное расписание. Забронируйте удобный слот.',
        'welcome.mock_verified': '✔ Проверен',
        'welcome.mock_book_btn': 'Бронь · 17:30',
        'welcome.how_step_3_title': 'Подключайтесь и говорите',
        'welcome.how_step_3_desc': 'Вход в один клик. Никаких лишних программ. 30 или 60 минут практики и полезная обратная связь.',
        'welcome.mock_starts_in': 'Урок начнется через 5 минут',
        'welcome.mock_freestyle': 'Свободный диалог · Дилноза · 1 час · 🕐 17:30',
        'welcome.mock_join': 'Присоединиться',
        'welcome.teachers_section_title': 'Сертифицированные учителя, готовые к урокам',
        'welcome.teachers_section_subtitle': 'Каждый профиль проверяется перед публикацией. Вот преподаватели, у которых есть свободные места на этой неделе.',
        'welcome.slots_available': 'Есть свободные слоты',
        'welcome.reviews': 'отзывов',
        'welcome.book_with_teacher': 'Забронировать урок с :name',
        'welcome.browse_all_teachers': 'Посмотреть всех проверенных учителей',
        'welcome.bottom_cta_title': 'Готовы говорить на английском уверенно?',
        'welcome.bottom_cta_subtitle': 'Забронируйте урок менее чем за 2 минуты. Бесплатно в период раннего бета-тестирования.',
        'welcome.book_now': 'Найти репетитора сейчас',
        'welcome.footer_rights_text': 'Все права защищены. Настоящие люди, реальные результаты.',
        'welcome.footer_privacy': 'Политика конфиденциальности',
        'welcome.footer_terms': 'Условия использования',
        'welcome.teacher_kamola_title': 'Специалист по IELTS Speaking',
        'welcome.teacher_kamola_desc': 'Стратегия экзамена и развитие беглости речи · 5 лет опыта',
        'welcome.teacher_kamola_badge': 'Преподаватель IELTS · ✔ Проверен',
        'welcome.teacher_javohir_title': 'Разговорная беглость',
        'welcome.teacher_javohir_desc': 'Уменьшение акцента и повседневный словарный запас · 4 года опыта',
        'welcome.teacher_javohir_badge': 'Общий английский · ✔ Проверен',
        'welcome.teacher_dilnoza_title': 'Бизнес-английский и подготовка к собеседованию',
        'welcome.teacher_dilnoza_desc': 'Корпоративный английский и симуляция интервью · 6 лет опыта',
        'welcome.teacher_dilnoza_badge': 'Бизнес-английский · ✔ Проверен',
        ...
        'auth.hourly_rate': 'Почасовая ставка',
        'auth.hourly_rate_placeholder': 'напр. 50 000 (может быть 0)',
        'auth.currency_som': 'сум',
        ...
        'auth.score_listening': 'Аудирование',
        'auth.score_reading': 'Чтение',
        'auth.score_writing': 'Письмо',
        'auth.score_speaking': 'Говорение',
        ...
        'auth.select_certificate': 'Выберите сертификат',
        ...
        'lang.other': 'Другой язык',
        'auth.lang_english': 'Английский',
        'auth.lang_korean': 'Корейский',
        'auth.lang_japanese': 'Японский',
        'auth.lang_german': 'Немецкий',
        'auth.lang_french': 'Французский',
        'auth.lang_cefr': 'Многоязычный',
        'auth.lang_other': 'Другой',
        'auth.custom_language_label': 'Название языка',
        'auth.custom_language_placeholder': 'напр. Испанский, Арабский, Итальянский',
        'auth.score_overall_toefl': 'Общий балл (0–120)',
        'auth.score_overall_det': 'Общий балл (10–160)',
        'auth.score_overall_topik': 'Общий балл',
        'auth.score_overall_jlpt': 'Общий балл (0–180)',
        'auth.score_overall_goethe': 'Общий балл (0–100)',
        'auth.score_overall_testdaf': 'Общий результат',
        'auth.score_overall_delf': 'Общий балл (0–100)',
        'auth.score_overall_cefr': 'Уровень CEFR',
        'auth.score_overall_custom': 'Общий балл / оценка',
        'auth.score_literacy': 'Грамотность (Literacy)',
        'auth.score_comprehension': 'Понимание (Comprehension)',
        'auth.score_conversation': 'Разговор (Conversation)',
        'auth.score_production': 'Продуцирование (Production)',
        'auth.score_language_knowledge': 'Знание языка',
        'auth.score_reading_de': 'Чтение (Lesen)',
        'auth.score_listening_de': 'Аудирование (Hören)',
        'auth.score_writing_de': 'Письмо (Schreiben)',
        'auth.score_speaking_de': 'Говорение (Sprechen)',
        'auth.score_reading_testdaf': 'Чтение (Leseverstehen)',
        'auth.score_listening_testdaf': 'Аудирование (Hörverstehen)',
        'auth.score_writing_testdaf': 'Письменная речь (Schriftlicher Ausdruck)',
        'auth.score_speaking_testdaf': 'Устная речь (Mündlicher Ausdruck)',
        'auth.score_listening_fr': 'Аудирование (Compréhension orale)',
        'auth.score_reading_fr': 'Чтение (Compréhension écrite)',
        'auth.score_writing_fr': 'Письменная речь (Production écrite)',
        'auth.score_speaking_fr': 'Устная речь (Production orale)',
        'auth.cert_file_optional': 'Файл сертификата (необязательно)',
        'auth.drop_cert_file': 'Перетащите сертификат сюда или выберите',
        'auth.drop_cert_hint': 'PDF, JPG или PNG · до 10 МБ',
        'auth.replace_file': 'Заменить',
        'auth.remove_file': 'Удалить',
        'teacher.view_certificate': 'Посмотреть сертификат',
        'teacher.verified_certificate': 'Подтвержденный сертификат',
        'teacher.open_original_file': 'Открыть оригинал документа',
        'teacher.close_modal': 'Закрыть',
        'teacher.click_to_expand': 'Нажмите для увеличения',
        'teacher.document_preview': 'Просмотр документа',
        'teacher.official_document_preview': 'Официальный документ сертификата',
        'teacher.pdf_preview_hint': 'Если документ не отображается в браузере, воспользуйтесь кнопками выше.',
        ...
        'payment.modal_desc':
            'Переведите оплату на карту ниже и отправьте чек в группу Telegram с указанием Вашего имени и ID ученика.',
        ...
        'payment.pupil_id': 'ID ученика',
        'payment.total_due': 'Итого к оплате',
        'payment.teacher_label': 'Преподаватель:',
        'payment.name_label': 'Имя:',
        'payment.id_label': 'ID:',
        'payment.warning_notice':
            'ОБЯЗАТЕЛЬНО: Укажите Ваше имя и ID ученика при отправке чека в Telegram, чтобы администраторы могли подтвердить бронирование.',
        ...
        'dashboard.book_now': 'Забронировать беседу',
        ...
        'dashboard.teacher_subtitle':
            'Управляйте своими уроками и доступностью.',
        'dashboard.completed_conversations': 'Завершенные уроки',
        'dashboard.completed_conversations_desc': 'Проведенные разговорные уроки',
        'dashboard.speaking_time': 'Общее время разговора',
        'dashboard.speaking_time_desc': 'Общее время в живых беседах',
        'teacher.completed_conversations': ':count уроков',
        'teacher.speaking_time': ':time общения',
        ...
        'gamification.day_streak': 'Серия :count дн.',
        'gamification.days_streak': 'Серия :count дн.',
        'gamification.shield_active': 'Щит активен',
        ...
        'gamification.leaderboard_practice_btn': 'Практиковаться',
        'gamification.empty_leaderboard_desc': 'Завершите урок или начните разговор, чтобы возглавить рейтинг!',
        'gamification.empty_leaderboard_action': 'Забронировать урок',
        'gamification.no_sessions_this_week': 'На этой неделе занятий пока не было',
        'gamification.user_minutes_spoken': ':count минут(ы) разговора на этой неделе',
        'gamification.top_five_badge': 'Топ-5 собеседник 🌟',
        'gamification.climb_ranks_hint': 'Продолжайте общаться, чтобы подняться в рейтинге! 🚀',
        'gamification.minutes_spoken': ':count минут',
        ...
        'gamification.xp_gained': 'Получено XP',
        'packages.title': 'Пакеты разговоров',
        'packages.admin_desc': 'Подтверждайте оплату для активации пакетов разговоров для учеников.',
        'packages.subtitle': 'Разговорные часы со скидкой с этим преподавателем',
        'packages.hours_count': ':count часов',
        'packages.discount_badge': 'Скидка :discount%',
        'packages.buy_button': 'Купить пакет',
        'packages.buying': 'Обработка...',
        'packages.price': 'Цена',
        'packages.regular_price': 'Обычно: :price',
        'packages.savings': 'Экономия :amount',
        'packages.teacher_discount': 'Скидка :amount',
        'packages.active_package': 'Активный пакет разговоров',
        'packages.remaining_time': 'Осталось: :time',
        'packages.covered_badge': 'Покрыто пакетом (Бесплатно)',
        'packages.covered_session_desc': 'Длительность урока: :duration. Остаток пакета после бронирования: :remaining.',
        'packages.insufficient_title': 'Недостаточно времени в пакете разговоров',
        'packages.insufficient_minutes': 'В вашем пакете осталось только :remaining. Для урока на :duration требуется обычная оплата или новый пакет.',
        'packages.rate_per_hour': 'Почасовая ставка',
        'packages.pending_verification': 'Оплата пакета ожидает проверки администратором',
        'packages.view_payment_details': 'Детали оплаты',
        'packages.create_pack': 'Создать пакет разговоров',
        'packages.edit_pack': 'Редактировать пакет',
        'packages.pack_title': 'Название пакета',
        'packages.pack_hours': 'Количество часов',
        'packages.pack_price': 'Стоимость пакета',
        'packages.no_packages': 'Пока нет доступных пакетов',
        'packages.status_active': 'Активен',
        'packages.status_inactive': 'Неактивен',
        'packages.delete_confirm': 'Вы уверены, что хотите удалить этот пакет?',
        'packages.purchase_success': 'Заявка на покупку пакета отправлена! Администратор скоро подтвердит оплату.',
        'packages.purchased_notice': 'У вас есть активный пакет с этим преподавателем! Ваши часы применяются автоматически для бесплатных бронирований.',
        'packages.manage_title': 'Пакеты разговоров',
        'packages.manage_desc': 'Предлагайте ученикам разговорные часы пакетами со скидкой.',
        'packages.modal_create_desc': 'Установите пакетные часы разговоров и скидки для учеников.',
        'packages.modal_edit_desc': 'Обновите часы, стоимость и описание пакета разговоров.',
        'packages.custom_hours': 'Другое кол-во',
        'packages.hours': 'Часов',
        'packages.pack_title_placeholder': 'Например: Пакет 5 часов разговора',
        'packages.pack_price_placeholder': 'Например: 400 000',
        'packages.discount_optional': 'Скидка % (Необязательно)',
        'packages.discount_placeholder': 'Например: 20',
        'packages.standard_rate_info': 'Стандартная ставка: :rate :currency / час (Стандартно за :hours: :total :currency)',
        'packages.desc_optional': 'Описание (Необязательно)',
        'packages.desc_placeholder': 'Например: Упор на IELTS speaking и свободную разговорную речь',
        'packages.cancel_btn': 'Отмена',
        'packages.save_btn': 'Сохранить пакет',
        'packages.update_btn': 'Обновить пакет',
        'packages.saving_btn': 'Сохранение...',
        'packages.empty_encourage': 'Мотивируйте учеников бронировать серии уроков, предлагая выгодные пакетные цены со скидкой.',
        'packages.hours_validation': 'Пожалуйста, введите корректное количество часов',
        'packages.price_validation': 'Пожалуйста, введите корректную цену',
        'packages.update_success': 'Пакет разговоров успешно обновлён',
        'packages.create_success': 'Пакет разговоров успешно создан',
        'packages.delete_success': 'Пакет удалён или деактивирован',
        'packages.delete_error': 'Не удалось удалить пакет',
        'packages.status_updated': 'Статус пакета обновлён',
        'packages.status_activated': 'Пакет ":name" активирован',
        'packages.status_deactivated': 'Пакет ":name" деактивирован',
        'packages.status_update_error': 'Не удалось обновить статус',
        'packages.error_duplicate_title': 'Пакет разговоров с таким названием уже существует.',
        'packages.error_duplicate_duration_discount': 'У вас уже есть пакет с такой продолжительностью и процентом скидки.',
        'auth.error_invalid_phone': 'Пожалуйста, введите корректный номер телефона (например: +998 90 123 45 67).',
        'auth.error_invalid_name': 'Имя должно содержать только буквы, пробелы и дефисы (минимум 2 символа).',

        // support page
        'support.title': 'Поддержка ConvoMate',
        'support.help_desk': 'Служба поддержки',
        'support.help_desk_desc': 'Свяжитесь с администрацией платформы ConvoMate, сообщите о проблеме или читайте объявления.',
        'support.send_message_title': 'Отправить сообщение администратору',
        'support.send_message_desc': 'Есть вопрос, отзыв или проблема с оплатой? Напишите нам напрямую.',
        'support.subject': 'Тема',
        'support.subject_placeholder': 'Например: Ошибка бронирования или вопрос по оплате',
        'support.message': 'Текст сообщения',
        'support.message_placeholder': 'Опишите вашу проблему или отзыв подробно...',
        'support.send_button': 'Отправить сообщение',
        'support.sending_button': 'Отправка...',
        'support.history_title': 'История сообщений',
        'support.history_desc': 'Ответы от администраторов и общесистемные объявления.',
        'support.no_messages': 'Сообщений пока нет',
        'support.no_messages_desc': 'Когда администраторы ответят на ваши запросы или опубликуют объявление, они появятся здесь.',
        'support.badge_broadcast': 'Объявление платформы',
        'support.badge_personal': 'Личное сообщение от админа',
        'support.badge_ticket': 'Обращение',
        'support.default_subject': 'Запрос в службу поддержки',
        'support.message_sent_success': 'Ваше сообщение отправлено в службу поддержки ConvoMate.',
        'support.official_broadcast': 'Официальное объявление администрации',
        'support.admin_label': 'Администратор',
        'support.you_sent': 'Вы отправили:',
        'nav.support': 'Поддержка ConvoMate',

        // sessions additional
        'sessions.mgmt_badge': 'Управление уроками',
        'sessions.history_badge': 'История уроков',
        'sessions.history_title': 'Мои уроки',
        'sessions.history_desc': 'Просматривайте все запланированные, предстоящие и прошедшие уроки с вашими учениками.',
        'sessions.tab_all': 'Все',
        'sessions.tab_upcoming': 'Предстоящие',
        'sessions.tab_completed': 'Завершённые',
        'sessions.trial_badge': 'Пробный · :duration мин',
        'sessions.lesson_badge': 'Урок · :duration мин',
        'sessions.paid_badge': 'Оплачено',
        'sessions.awaiting_payment': 'Принято · Ожидает оплаты',
        'sessions.new_student_desc': '— новый ученик, первое занятие с вами',
        'sessions.third_of_rate': '⅓ от вашей ставки',
        'sessions.full_rate': 'полная ставка',
        'sessions.join_lesson': 'Войти в урок',
        'sessions.feedback_btn': 'Оставить отзыв',
        'sessions.your_feedback_prefix': 'Ваш отзыв:',
        'sessions.no_lessons': 'Уроки не найдены',
        'sessions.no_lessons_desc': 'Неоплаченные бронирования здесь не отображаются — урок появляется только после оплаты учеником.',
        'sessions.unpaid_note': '✦ Неоплаченные бронирования здесь не отображаются — урок появляется только после оплаты учеником.',
        'sessions.quick_stats': 'Быстрая статистика',
        'sessions.trials_this_week': 'Пробных на этой неделе',
        'sessions.marketplace_tip_title': 'Совет преподавателю',
        'sessions.marketplace_tip_desc': 'Пробный урок — это ваша визитная карточка. Оцените уровень ученика, выделите 2–3 точки роста и предложите регулярный план занятий.',
        'sessions.new_trial_toast': 'Новый пробный урок',
        'sessions.trial_toast_desc': 'забронировал(а) пробный урок · :time · :price, уже оплачено.',
        'sessions.trial_toast_body': ':name забронировал(а) пробный урок · :time · :price :currency, уже оплачено. Совет: оцените уровень и составьте план.',
        'sessions.session_started': 'Урок начат',
        'sessions.google_calendar_required': 'Для создания ссылки Google Meet требуется подключение к Google Календарю.',
        'sessions.connect_google': 'Подключить Google',
        'sessions.cannot_start_session': 'Не удалось начать урок',
        'sessions.student_fallback': 'Ученик',
        'sessions.teacher_fallback': 'Преподаватель',
    },
};
...
export function useTranslation() {
    ...
    const t = (
        ...
        possibleReplacements?: Record<string, string | number>,
    ) => {
        const langDict =
        ...
        let text = val !== undefined ? val : (fallback ?? key);
