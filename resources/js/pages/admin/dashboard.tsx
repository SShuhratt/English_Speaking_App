        ...
        <>
            ...
            <div className="mx-auto max-w-7xl space-y-8 p-4 md:p-8">
                    ...
                    <Card className="border-amber-200 bg-amber-50/40 dark:border-amber-900/50 dark:bg-amber-950/20">
                        ...
                        <CardContent>
                            ...
                            <p className="mt-1 text-xs text-amber-700 dark:text-amber-400">
                                Bookings accepted by teachers waiting for
                    ...
                    <Card className="border-red-200 bg-red-50/40 dark:border-red-900/50 dark:bg-red-950/20">
                        ...
                        <CardContent>
                            ...
                            <p className="mt-1 text-xs text-red-700 dark:text-red-400">
                                Payments rejected with reason communicated to
                                users
                            </p>
                        </CardContent>
                    </Card>
                ...
                <Dialog
                    ...
                    onOpenChange={() => setSelectedRejectId(null)}
                >
                    <DialogContent className="sm:max-w-md">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Please enter the reason for rejecting this
                                payment. This reason will be displayed to both
                                teacher and pupil.
                            </DialogDescription>
                        </DialogHeader>
